...
{
    private bool hasEnabledCameraControl = true;
	...
	{
        EventManager.StartListening("EndLevel", LockCameraControl);
	...
	{
        EventManager.StopListening("EndLevel", LockCameraControl);
